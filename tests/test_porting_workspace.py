...
class PortingWorkspaceTests(unittest.TestCase):
    ...
    def test_archived_placeholder_packages_are_removed(self) -> None:
        import importlib.util

        self.assertIsNone(importlib.util.find_spec('src.assistant'))
        self.assertIsNone(importlib.util.find_spec('src.bridge'))
