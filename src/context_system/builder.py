"""Synchronous context prompt builder."""
...
def build_context_prompt(
    ...
    *,
    ...
    claude_section = _build_claude_md_section(str(current))
    if claude_section:
...
def _build_claude_md_section(cwd: str) -> str:
